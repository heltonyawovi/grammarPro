...
const jsonDiff = new _base.default(); // Discriminate between two lines of pretty-printed, serialized JSON where one of them has a
...
},{"../util/params":18,"./base":4}],9:[function(require,module,exports){
"use strict";
...
},{"../util/params":18,"./base":4}],11:[function(require,module,exports){
"use strict";
...
},{"./convert/dmp":1,"./convert/xml":2,"./diff/array":3,"./diff/base":4,"./diff/character":5,"./diff/css":6,"./diff/json":7,"./diff/line":8,"./diff/sentence":9,"./diff/word":10,"./patch/apply":12,"./patch/create":13,"./patch/merge":14,"./patch/parse":15}],12:[function(require,module,exports){
"use strict";
...
},{"../util/distance-iterator":17,"./parse":15}],13:[function(require,module,exports){
"use strict";
...
function merge(mine, theirs, base) {
  ...
  let ret = {}; // For index we just let it pass through as it doesn't have any necessary meaning.
...
},{"../util/array":16,"./create":13,"./parse":15}],15:[function(require,module,exports){
"use strict";
...
function parsePatch(uniDiff, options = {}) {
  ...
  function parseIndex() {
    ...
    while (i < diffstr.length) {
      let line = diffstr[i]; // File header found, end parsing diff metadata
